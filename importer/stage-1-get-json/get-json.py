...
# TODO: Is this needed in this case? if so it needs to be improved to also split the card text. 
...
# Grab cards
airtable_to_json_file(transformers_card_id, key, 'Bot Cards', 'target/tmp/bot-cards.json', bot_mutate)
airtable_to_json_file(transformers_card_id, key, 'Battle Cards', 'target/tmp/battle-cards.json')
airtable_to_json_file(transformers_card_id, key, 'Combiner Forms', 'target/tmp/combiner-forms.json')
